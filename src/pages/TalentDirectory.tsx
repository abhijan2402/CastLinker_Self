    ...
    <div className="space-y-4 pr-1">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Discover and connect with talented film industry professionals
            ...
            <div className="flex gap-2">
              ...
              <Sheet>
                <SheetTrigger asChild>
                  <Button
                    variant="outline"
                    className="border-gold/10 focus:ring-gold/30"
                  >
                ...
                <SheetContent className="w-[300px] sm:w-[400px] bg-cinematic-dark border-gold/10">
                  <SheetHeader>
                    ...
                    <SheetDescription>
                      Refine your talent search with specific criteria.
                    </SheetDescription>
                  </SheetHeader>
                  ...
                  <div className="mt-6 space-y-6">
                    <div className="space-y-3">
                      ...
                      <ProfessionFilter
                        ...
                        onProfessionChange={(professions) =>
                          updateFilters({ selectedRoles: professions })
                        }
                      />
                    </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              updateFilters({ availableOnly: !!checked })
                            }
                            className="border-gold/30 data-[state=checked]:bg-gold data-[state=checked]:border-gold"
                          />
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              updateFilters({
                                likesMinimum: parseInt(e.target.value) || 0,
                              })
                            }
                            className="h-8 w-24"
                          />
      ...
      {(filters.selectedRoles.length > 0 ||
        ...
        <div className="flex flex-wrap items-center gap-2 mt-3">
          ...
          {(filters.experienceRange[0] > 0 ||
            ...
            >
              Experience: {filters.experienceRange[0]}-
              {filters.experienceRange[1]}+ yrs
              <span className="ml-1 text-xs">×</span>
            </Button>
          )}
      ...
      <div className="flex justify-between items-center mt-3">
        <p className="text-sm text-foreground/70">
          Found <span className="text-gold font-medium">{totalCount}</span>{" "}
          talents
        </p>
      </div>
        ...
        {isLoading ? (
                  ...
                  {/* <Button
                    ...
                    className={`px-3 border-gold/20 ${
                      wishlistedProfiles?.includes(profile.id)
                        ...
                        : "hover:bg-amber-950/20 hover:text-amber-400"
                    }`}
          ...
          <div className="col-span-3 bg-card border border-gold/10 rounded-xl p-8 text-center">
            ...
            <p className="text-foreground/70 mb-4">
              Try adjusting your search criteria or filters to find talents that
              match your needs.
            </p>
            <Button
              onClick={resetFilters}
