...
const IndustryHub = () => {
  ...
  const featuredEvent =
    events.find((item) => item.is_featured) ||
    (events.length > 0 ? events[0] : null);
  const featuredCourse =
    courses.find((item) => item.is_featured) ||
    ...
    <div className="space-y-4 pr-1">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Stay informed, learn, and grow with the latest news, events, and
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-sm text-foreground/60">
                        {featuredNews.category || "Industry Analysis"}
                      </span>
                    </div>
            ...
            <div className="lg:col-span-3 text-center mt-4">
              <Button
                ...
                onClick={() =>
                  setDialogOpen((prev) => ({ ...prev, news: true }))
                }
              >
          ...
          <div className="space-y-6">
                    ...
                    <div className="p-8 lg:col-span-3">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="text-sm font-medium">
                              {featuredEvent.location || "Virtual Event"}
                            </p>
                            <p className="text-xs text-foreground/60">
                              {featuredEvent.type || "Workshop"}
                            </p>
                          </div>
                        </div>
                      </div>
            ...
            <div className="text-center mt-8">
              <Button
                ...
                className="border-gold/30 hover:border-gold mr-4"
                onClick={() =>
                  setDialogOpen((prev) => ({ ...prev, events: true }))
                }
              >
                <Plus className="mr-2 h-4 w-4" />
                Submit Event
          ...
          <div className="space-y-8">
              ...
              <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-card border border-gold/10 rounded-xl p-6 text-center">
                  ...
                  <p className="text-sm text-foreground/70">
                    Step-by-step instructions for film professionals
                  </p>
                </div>
                <div className="bg-card border border-gold/10 rounded-xl p-6 text-center">
                  ...
                  <p className="text-sm text-foreground/70">
                    Professional documents for various purposes
                  </p>
                </div>
                <div className="bg-card border border-gold/10 rounded-xl p-6 text-center">
                ...
                <div className="bg-card border border-gold/10 rounded-xl p-6 text-center">
                  ...
                  <p className="text-sm text-foreground/70">
                    Tools to advance your film career
                  </p>
                </div>
              </div>
            </div>
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundImage: `url(${
                          resource.file_url ||
                          "https://images.unsplash.com/photo-1581557991964-125469da3b8a?q=80&w=1000"
                        })`,
                      }}
                    ></div>
                    <CardHeader>
            ...
            <div className="text-center mt-8">
              <Button
                ...
                className="border-gold/30 hover:border-gold mr-4"
                onClick={() =>
                  setDialogOpen((prev) => ({ ...prev, resources: true }))
                }
              >
                <Plus className="mr-2 h-4 w-4" />
                Submit Resource
      ...
      <div className="bg-card border border-gold/10 rounded-xl p-8 text-center">
        ...
        <p className="text-foreground/80 mb-6 max-w-2xl mx-auto">
          Stay updated with the latest news, events, and resources from the film
          industry. No spam, just valuable content delivered to your inbox.
        </p>
        <form
