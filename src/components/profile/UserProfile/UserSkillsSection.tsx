...
const UserSkillsSection = ({ userProfile }) => {
  ...
  useEffect(() => {
    ...
    const profileSkills = isSkillArray(userProfile?.acting_skills)
      ? userProfile.acting_skills
      : defaultSkills;
    ...
    const profileTechnicalSkills = isSkillArray(userProfile?.technical_skills)
    ...
    // Special Skills
    if (
      userProfile?.special_skills &&
      Array.isArray(userProfile.special_skills)
    ) {
      setSkills({
        specialSkills: userProfile.special_skills,
      });
    }
  }, [
